...
### Read input
################################################
#INfile="/projects_eg/projects/marta/hcc_normal_totalRNA/analysis/11_PeptideBindingMHC/noncanonical_CIPHER/Patient12/Patient12_noncanonical_all_orfs_FPKM1_notduplis_PROTEIN_8aa_cleanheader.netMHCpan.BA.xls"
