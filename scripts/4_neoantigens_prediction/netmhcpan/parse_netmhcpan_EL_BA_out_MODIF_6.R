...
### Read input
################################################
#INfile="/Users/martaespinosa/Desktop/IMIM/liver_adjacent_totalRNA/analysis/11_PeptideBindingMHC/translation_evidence_NOCDS/HCC_31/HCC_31_translational_evidence_PROTEIN.netMHCpan.BA.xls"
