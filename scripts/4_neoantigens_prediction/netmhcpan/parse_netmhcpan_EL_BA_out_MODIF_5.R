...
### Read input
################################################
#INfile="/Users/martaespinosa/Desktop/IMIM/zou_hcc_RP_totalRNA/analysis/11_PeptideBindingMHC/translation_evidence_NOCDS/LC001/LC001_translational_evidence_PROTEIN.netMHCpan.BA.xls"
